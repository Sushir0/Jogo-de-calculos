...
public class Binario {
    ...
    public static Integer probabilidadeTipoDeConversao = 0;//Tipos de conversão:binário p/ decimal ou decimal p/ binário
    ...
    public static void getRespostas() {
        ...
        if (probabilidadeTipoDeConversao == 0) {
            Integer[] respostasInteger = GetRespostas.getRespostasUnicas(respostaVerdadeira_Decimal);
            String[] respostasString = Conversor.arrayInteger_String(respostasInteger);

            respostas = Binario.colocarRespostaVerdadeiraNasRespostas(respostasString);
            ...
            respostas = Binario.colocarRespostaVerdadeiraNasRespostas(Conversor.ArrayDecimal_Binario(respostas_Decimal));
        ...
        for (int i = 0; i < Engine.QtdRespostas; i++) {
            if (i == probabilidade) {
                if (probabilidadeTipoDeConversao == 0) {
                    ...
                    Respostas[i] = Conversor.Decimal_Binario(respostaVerdadeira_Decimal);
    ...
    public static void getVariavel() {
        ...
        if (probabilidadeTipoDeConversao == 0) {
            ...
            variavel = Conversor.Decimal_Binario(respostaVerdadeira_Decimal);
